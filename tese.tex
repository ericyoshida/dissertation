...
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\course{Electronic Engineering and Computer Science}  % TODO: confirmar nome do Programa de Pós-Graduação
\area{Informatics}                                    % TODO: confirmar área de concentração
...
% Título da Dissertação (título travado, conforme slides de defesa)
\title{Convolutional Neural Networks for Urban Autonomous Aerial Vehicle Situational Awareness: A Camera--Point Cloud Fusion Approach for Obstacle Detection and Tracking}

% Orientador
\advisorgender{masc}                    % masc ou fem
\advisor{Prof.~Dr.}{Marcos Ricardo Omena de Albuquerque Máximo}{ITA}

% Coorientador
\coadvisorgender{masc}                  % masc ou fem
\coadvisor{Prof.~Dr.}{Stiven Schwanz Dias}{Embraer S.A.}

% Pró-reitor da Pós-graduação
\bossgender{masc}                       % masc ou fem
\boss{Prof.~Dr.}{[Nome do Pró-Reitor da Pós-Graduação]}   % TODO: confirmar
...
% Membros da banca examinadora (TODO: confirmar banca)
\examiner{Prof.~Dr.}{[Examinador 1 --- Presidente]}{}{ITA}
\examiner{Prof.~Dr.}{[Examinador 2]}{}{ITA}
\examiner{Prof.~Dr.}{[Examinador 3 --- Externo]}{}{}

% Data da defesa (mês em maiúsculo, pois o trabalho é em inglês)
\date{XX}{Month}{2026}                  % TODO: data da defesa
...
\FRDitadata{XX de mês de 2026}                                   % TODO: data
...
\FRDitapalavraapresentacao{ITA, São José dos Campos. Curso de Mestrado. Programa de Pós-Graduação em [Programa]. Área de [Área]. Orientador: Prof.~Dr.~Marcos Ricardo Omena de Albuquerque Máximo; Coorientador: Prof.~Dr.~Stiven Schwanz Dias. Defesa em XX/XX/2026.}   % TODO
