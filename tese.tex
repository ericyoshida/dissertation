...
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
% Paginação conforme o manual do ITA (Seção 4.1):
%   - todas as folhas contam a partir da folha de rosto, inclusive;
%   - da folha da banca em diante o número é impresso, no canto superior direito;
%   - a folha de rosto e o seu verso são contados, mas não numerados;
%   - a Folha de Registro, no fim, não conta e não é numerada.
% A classe usa \thispagestyle{empty} nas folhas de abertura (banca, dedicatória,
% agradecimentos, epígrafe, resumo, listas, sumário) e o estilo plain no início
% de cada capítulo, e ambos escondem o número. Os dois passam a imprimi-lo.
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\makeatletter
\newcommand{\ita@numnohead}{%
  \renewcommand{\@oddhead}{\hfill\thepage}%
  \renewcommand{\@evenhead}{\thepage\hfill}%
  \renewcommand{\@oddfoot}{}\renewcommand{\@evenfoot}{}}
\renewcommand{\ps@empty}{%
  \renewcommand{\@oddhead}{\ifnum\value{page}>2\hfill\thepage\fi}%
  \renewcommand{\@evenhead}{\ifnum\value{page}>2\thepage\hfill\fi}%
  \renewcommand{\@oddfoot}{}\renewcommand{\@evenfoot}{}}
\renewcommand{\ps@plain}{\ita@numnohead}
\makeatother
...
\itaauthoraddress{Rua Francisco Ricci, 181, Apto. 194D, Vila Ema}{12.243-261}{São José dos Campos--SP}
...
% O template novo do ITA não traz mais o nome do Pró-Reitor na folha de rosto
% (confirmado pelo orientador). O bloco é suprimido esvaziando \@boss, que a
% classe imprime na folha de rosto; \boss não é chamado.
% Titular à época, caso volte a ser exigido: Prof. Dr. André Valdetaro Gomes Cavalieri.
\bossgender{masc}
\makeatletter\gdef\@boss{}\makeatother
...
% Membros da banca examinadora (a ordem na folha: Presidente, Orientador, Coorientador,
% demais membros). Somente quem participou da defesa entra na folha da banca; os
% suplentes Cesar Augusto Cavalheiro Marcondes (ITA) e Thiago Oliveira Santos (UFES)
% foram retirados a pedido da Secretaria da Pós-Graduação.
...
% Folha de Registro do Documento (FRD) --- nao conta e nao e numerada
\makeatletter
\renewcommand{\ps@empty}{\renewcommand{\@oddhead}{}\renewcommand{\@evenhead}{}%
  \renewcommand{\@oddfoot}{}\renewcommand{\@evenfoot}{}}
\makeatother
\FRDitadata{31 de agosto de 2026}                                 % campo 2: fornecido pela Biblioteca
\FRDitadocnro{DCTA/ITA/DM-077/2026}                              % campo 3: fornecido pela Biblioteca
...
\FRDitapalavrasresult{Redes neurais; Processamento de imagens; Rastreamento (posição); Aeronaves não-tripuladas; Filtro de Kalman; Fusão de sensores; Detecção; Monitoramento; Computação.}   % campo 9: indexação da Biblioteca
\FRDitapalavraapresentacao{ITA, São José dos Campos. Curso de Mestrado. Programa de Pós-Graduação em Eletrônica e Computação. Área de Informática. Orientador: Prof.~Dr.~Marcos Ricardo Omena de Albuquerque Maximo; coorientador: Dr.~Stiven Schwanz Dias. Defesa em 28/07/2026.}   % redação da Biblioteca
\FRDitaresumo{\input{PreTextuais/abstract_frd}}
