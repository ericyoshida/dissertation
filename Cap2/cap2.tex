...
Object detection localizes and classifies objects within an image. One-stage
...
real-time throughput required onboard a UAV; recent versions of the family
augment the convolutional backbone with attention mechanisms while preserving
this single-pass design. The 2D detector forms the first stage
...
generalization; this strategy is applied to the aerial person detector of
