...
linear-Gaussian special case --- $\bm{f}(\bm{x})=\bm{F}\bm{x}$,
...
The tracking models of this work are nonlinear --- the platform rotates and the
...
Three families of metrics are used to evaluate the estimators.
...
of the pipeline and seeds the frustum used for 3D detection.
