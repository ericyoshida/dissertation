...
detector's operating envelope so that it generalises to a deployment environment
...
real-time inference, and centre-based heads \cite{zhou2019objects} predict object
centres as heatmap peaks. This paradigm removes the recall ceiling imposed by the
...
detector on their union is what yields the cross-domain generalisation exploited
