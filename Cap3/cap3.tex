...
Three-dimensional detection by camera--LiDAR fusion is most developed in the
autonomous-driving domain, where it follows two broad designs. The first, and the
