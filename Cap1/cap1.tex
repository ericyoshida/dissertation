...
\begin{enumerate}
  ...
  absence of large-scale real data.
...
\begin{enumerate}
  ...
  uncertain; the filter propagates the six-degree-of-freedom camera-pose
  covariance into its innovation, yielding consistent estimates under aggressive
  platform motion.
  ...
  AirSim addresses the scarcity of three-dimensional aerial data and is used to
  train the CNN-based two- and three-dimensional detectors of the pipeline.
...
the common theoretical framework --- recursive Bayesian estimation and the EKF,
coordinate frames, motion and measurement models, consistency metrics, and the
