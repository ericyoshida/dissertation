...
collision risk and time-to-conflict. The velocity estimate lets Avoid
anticipate a conflict rather than react to the present position, which is the
...
\begin{enumerate}
  ...
  component: it is unobservable from a single monocular view and must be recovered
  from additional assumptions or sensors, and even active range sensors degrade
